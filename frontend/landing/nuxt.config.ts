...
export default defineNuxtConfig({
    ...
    sitemap: {
        ...
        urls: [
            ...
            { loc: '/layanan/sistem-pelaporan-k3', changefreq: 'weekly', priority: 0.84 },
            { loc: '/layanan/sistem-informasi-klinik', changefreq: 'weekly', priority: 0.84 },
            { loc: '/layanan/sistem-manajemen-transaksi', changefreq: 'weekly', priority: 0.84 },
