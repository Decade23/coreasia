...
export const CONTENT = {
  id: {
    ...
    about: {
      ...
      description: 'Mengenal lebih dekat CoreAsia better - digital transformation partner for educational institutions and professional certification bodies in Indonesia.',
      kicker: 'Our Vision',
      hero: {
    ...
    solutions: {
      ...
      venture: {
        ...
        hero: {
          title: 'Launch bisnis digital dengan model <span class="ca-gradient-text">bagi hasil</span> yang transparan.',
