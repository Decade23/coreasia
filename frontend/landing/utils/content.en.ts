...
const EN_CONTENT = mergeLocaleContent(ID_CONTENT, {
  ...
  home: {
    ...
    services: {
      ...
      items: [
        ...
        { label: 'Safety Reporting System', description: 'Incident recaps, committee minutes, and inspection evidence ready to become the periodic report.', to: '/layanan/sistem-pelaporan-k3' },
        { label: 'Clinic Information System', description: 'Integration, medical record migration, and extra modules for healthcare facilities.', to: '/layanan/sistem-informasi-klinik' },
        { label: 'Transaction Management System', description: 'Orders, invoicing, and stock whose records finally match each other.', to: '/layanan/sistem-manajemen-transaksi' },
      ],
    },
    readyCTA: {
  ...
  contact: {
    ...
    form: {
      ...
      subjects: {
        ...
        k3: 'Safety Reporting System',
        klinik: 'Clinic Information System',
        operasional: 'Transaction Management System',
        lms: 'CoreAsia LMS',
  ...
  services: {
    ...
    sistemPelaporanK3: {
      title: 'Occupational Safety Reporting and Documentation System',
      description: 'Incident records, safety committee minutes, and inspection evidence kept in one place and ready to become the periodic report for the labour office, built around the format you already use.',
      kicker: 'Safety Documentation System',
      hero: {
        title: 'Stop rebuilding the safety report <span class="ca-gradient-text">from scratch every period</span>',
        subtitle: 'Incidents live in a chat group, minutes live in a word processor file, inspection photos live on an officer phone. We move all of it into one place whose output is already shaped like the report.',
        ctaPrimary: 'Free Consultation',
        ctaSecondary: 'View Portfolio',
        ctaTertiary: 'Read the Legal Basis',
      },
      problems: {
        title: 'What usually happens as the reporting deadline approaches',
        subtitle: 'If you recognise three of these six, the problem is not how careful your people are.',
        items: [
          { icon: 'lucide:message-square-warning', title: 'Incidents reported in a chat group', description: 'An incident is reported in chat, then buried under the other messages of the same day. Months later the date and sequence have to be guessed.' },
          { icon: 'lucide:folder-search', title: 'Minutes scattered across folders', description: 'Every secretary saves files under a personal naming habit. Finding the minutes of one particular month becomes half a day of work.' },
          { icon: 'lucide:image-off', title: 'Inspection photos stop on the officer phone', description: 'Visual evidence exists, but it is not attached to the finding. When the report is written, nobody can tell which photo belongs to which item.' },
          { icon: 'lucide:file-spreadsheet', title: 'The recap is rebuilt every period', description: 'The recap file is copied from the previous period and edited. Old mistakes are copied along and only surface during an inspection.' },
          { icon: 'lucide:user-x', title: 'The secretary changes and the archive leaves too', description: 'Document history is attached to a person, not to the company. The next officer starts from zero.' },
          { icon: 'lucide:map-pin-off', title: 'The same report is rebuilt for every provincial office', description: 'There is a single format, set out in the Annex to Permenaker 13 of 2025, but it goes to the provincial manpower office of each site. A company with many sites assembles that report over and over from the same underlying data.' },
        ],
      },
      outcomes: {
        title: 'What changes once it is sorted out',
        subtitle: 'Not more administrative work. Recording moves to a place whose output is already the report.',
        items: [
          { icon: 'lucide:clipboard-check', title: 'The report is reviewed, not assembled', description: 'Data goes in once when the event is recorded. The reporting period becomes a date range and a review.' },
          { icon: 'lucide:smartphone', title: 'Findings are recorded on site', description: 'Officers log findings and attach photos from a phone while the inspection is running, instead of retyping them back at the office.' },
          { icon: 'lucide:history', title: 'History survives a change of people', description: 'Minutes, attendance, and follow-ups belong to the company. The next officer opens the same archive.' },
          { icon: 'lucide:list-checks', title: 'Follow-ups have an owner and a due date', description: 'An inspection finding does not end as a note. Every item has an owner and a visible status.' },
          { icon: 'lucide:download', title: 'Output follows the official format', description: 'Exports are shaped to the Annex of Permenaker 13 of 2025 and can be split per work site, so each provincial office receives the report for its own site.' },
          { icon: 'lucide:shield-check', title: 'Ready for inspection without a scramble', description: 'When an inspection arrives, supporting documents are complete and dated, not collected the night before.' },
        ],
      },
      scope: {
        title: 'Scope of work',
        subtitle: 'Delivered in stages. The most used part is built first so it can be in service before the whole system is finished.',
        items: [
          { icon: 'lucide:file-plus', title: 'Incident and near-miss records', description: 'Incident forms covering sequence, location, people involved, actions taken, and evidence attachments.' },
          { icon: 'lucide:users', title: 'Safety committee meetings and membership', description: 'Meeting schedules, attendance, minutes, and decisions that can be traced per period.' },
          { icon: 'lucide:clipboard-list', title: 'Inspections and findings', description: 'Inspection checklists you can compose yourself, findings, photos, and follow-ups with named owners.' },
          { icon: 'lucide:file-output', title: 'Recap and report export', description: 'Per-period recaps and export files shaped to the Annex of Permenaker 13 of 2025, split per work site where that is needed.' },
          { icon: 'lucide:graduation-cap', title: 'Trainee files and certificates', description: 'For safety training providers: participant registration, document completeness, certificate issuance and delivery.' },
          { icon: 'lucide:key-round', title: 'Roles and access rights', description: 'Separate access for committee officers, field staff, and management, including companies with several sites.' },
        ],
      },
      regulation: {
        title: 'The regulations we rely on',
        subtitle: 'Every claim below can be checked against the official document. We do not quote third-party summaries.',
        items: [
          {
            title: 'Obligation to form a safety committee',
            body: 'Article 3 paragraph (2) of Minister of Manpower Regulation Number 13 of 2025 requires a safety committee at any workplace or company employing at least 100 workers, or carrying a high risk level. The parent basis is Article 10 of Law Number 1 of 1970 on Occupational Safety.',
            sourceLabel: 'Permenaker 13 of 2025 at JDIH Kemnaker',
            sourceUrl: 'https://jdih.kemnaker.go.id/peraturan/detail/2788/peraturan-menteri-ketenagakerjaan-nomor-13-tahun-2025',
            sourceLabel2: 'Law Number 1 of 1970 at JDIH BPK',
            sourceUrl2: 'https://peraturan.bpk.go.id/Details/47614/uu-no-1-tahun-1970',
          },
          {
            title: 'Periodic reporting, submitted electronically',
            body: 'Article 11 paragraph (1) requires the committee chair to submit activity reports once every six months, or at any time when required. Paragraph (2) states the report is submitted electronically through an information system managed by the Ministry of Manpower, and paragraph (3) allows manual submission while that system is not yet available.',
            sourceLabel: 'Permenaker 13 of 2025 at JDIH Kemnaker',
            sourceUrl: 'https://jdih.kemnaker.go.id/peraturan/detail/2788/peraturan-menteri-ketenagakerjaan-nomor-13-tahun-2025',
          },
          {
            title: 'The 19 November 2026 deadline',
            body: 'Article 15 states the reporting information system must be established within one year of promulgation. The regulation was promulgated on 19 November 2025, so the deadline falls on 19 November 2026. Companies whose records are still scattered will struggle to fill in whatever shape that system takes.',
            sourceLabel: 'Permenaker 13 of 2025 at JDIH BPK',
            sourceUrl: 'https://peraturan.bpk.go.id/Details/342991/permenaker-no-13-tahun-2025',
          },
          {
            title: 'Website-based self inspection',
            body: 'Article 49 paragraph (1) of Minister of Manpower Regulation Number 11 of 2026 states that supervision system development may be carried out through website-based self inspection of labour norms by the company, with the result verified by a labour inspector. The regulation uses may, not must, and the trigger sits with the inspector.',
            sourceLabel: 'Permenaker 11 of 2026 at JDIH Kemnaker',
            sourceUrl: 'https://jdih.kemnaker.go.id/peraturan/detail/3070/peraturan-menteri-ketenagakerjaan-nomor-11-tahun-2026',
          },
        ],
        disclaimer: 'Two things we deliberately do not use as an argument. First, PER.04/MEN/1987, still widely quoted as the basis for safety committees, was revoked and declared no longer in force by Article 16 of Permenaker 13 of 2025. Second, the National Safety Month is an activity guideline, not a digitisation obligation, so we do not use it as a reason to buy anything.',
      },
      pricing: {
        title: 'Cost and duration range',
        subtitle: 'The exact figure follows a locked scope. What we can state now is the entry point and what moves your position inside the range.',
        headline: 'Web-based internal system',
        range: 'From Rp 25 million',
        lowPrice: '25000000',
        duration: 'Delivery in 4 to 12 weeks',
        note: 'The entry point and duration above follow the Web App Custom package already published on our website development page. The upper bound depends on the final scope and is written into the proposal before work begins.',
        noteLinkLabel: 'Check the Web App Custom package on our website development page',
        noteLinkTo: '/layanan/jasa-pembuatan-website#paket-harga',
        factorsTitle: 'What decides your position inside the range',
        factors: [
          { icon: 'lucide:building', title: 'Number of work sites', description: 'One site is not the same as six, because each site has its own report and its own destination office, so the data has to stay separate from the moment it is recorded.' },
          { icon: 'lucide:users-round', title: 'Number of roles and users', description: 'The more access distinctions there are, the more has to be tested before the system goes into use.' },
          { icon: 'lucide:file-input', title: 'Condition of existing data', description: 'An archive already tidy in a spreadsheet is cheaper to move than a mix of paper and photos.' },
          { icon: 'lucide:plug', title: 'Connections to other systems', description: 'Pulling employee data from an existing HR system adds work compared with manual entry.' },
          { icon: 'lucide:smartphone', title: 'Field usage', description: 'Filling forms from a phone during an inspection needs different handling from filling them at a desk.' },
          { icon: 'lucide:file-check-2', title: 'Required output formats', description: 'One export format is not the same as several formats that must be maintained side by side.' },
        ],
      },
      caseStudy: {
        kicker: 'Case Study',
        title: 'Training management system for a safety training provider',
        sector: 'A client outside CoreAsia, running in production',
        description: 'Registrations from the public site land straight in the back office under their own registration code, participant documents stay attached to that registration, and every status change is stored together with the person who made it. Training schedules, site content, and the access rights of each role are managed from the same place.',
        points: [
          'Registrations from the public site reach the back office without retyping',
          'Participant documents stay attached to their registration',
          'Registration status changes are recorded with the person who made them',
          'Roles and access rights are configured by the provider itself',
        ],
        note: 'Two things you should know up front. What we name here is the sector, not the institution. And we have never built the safety committee reporting system itself for a client, so what is proven here is participant handling, document completeness, and the change trail.',
        ctaLabel: 'See the full portfolio',
      },
      related: {
        title: 'Other pages you may need',
        subtitle: 'If your problem turns out not to be safety documentation, these three are closer.',
        items: [
          { icon: 'lucide:receipt', title: 'Transaction and operations system', description: 'For messy orders and invoicing rather than compliance documentation.', to: '/layanan/sistem-manajemen-transaksi' },
          { icon: 'lucide:stethoscope', title: 'Clinic and medical record system', description: 'For healthcare facilities whose system exists but is not connected yet.', to: '/layanan/sistem-informasi-klinik' },
          { icon: 'lucide:layout-dashboard', title: 'Web application development', description: 'The general page for internal systems outside these three categories.', to: '/layanan/jasa-pembuatan-aplikasi-web' },
        ],
      },
      faq: {
        title: 'Questions that come up often',
        items: [
          { question: 'How often must safety committee activity reports be submitted?', answer: 'Article 11 paragraph (1) of Permenaker 13 of 2025 states reporting is submitted once every six months, or at any time when required. If you have been reporting quarterly, that likely follows an older habit or a local office request. We build the system so it can serve both.' },
          { question: 'We have fewer than 100 employees, is a safety committee still required?', answer: 'Article 3 paragraph (2) sets two alternative criteria: employing at least 100 workers, or carrying a high risk level. Paragraph (3) states the high risk determination follows business licensing regulations. Headcount is therefore not the only factor.' },
          { question: 'We already use spreadsheets, do we need a system?', answer: 'If one person holds the file and it rarely changes, a spreadsheet is still enough and we will not tell you to replace something that works. Trouble usually starts when more than one person fills it in, when photo attachments are needed, and when the change history has to be traced.' },
          { question: 'Can old data be migrated?', answer: 'Yes, as long as it is still readable. Spreadsheet archives move faster. For paper and photos, decide first what genuinely needs to come across, because moving everything is rarely worth the cost.' },
          { question: 'Does CoreAsia supply certified safety officers?', answer: 'No. We build the system, we do not supply personnel or certification services. Article 5 paragraph (3) of Permenaker 13 of 2025 requires the committee secretary to be an appointed safety expert, and that sits outside our service.' },
          { question: 'Does the system submit to the labour office portal automatically?', answer: 'No, and we do not promise it. Article 11 paragraph (2) of Permenaker 13 of 2025 states the report is submitted through an information system managed by the Ministry of Manpower, and Article 15 gives until 19 November 2026 for that system to be established. Until that channel is open to outside systems, what we prepare is output shaped to the Annex of the regulation and ready for you to send to the destination provincial office.' },
          { question: 'How long until it can be used?', answer: 'The recording part usually goes live first, with recaps and exports following. The full delivery range follows the Web App Custom package on our website development page, that is 4 to 12 weeks depending on scope.' },
        ],
      },
      cta: {
        title: 'Show us the report you send today',
        subtitle: 'Send one example from the last period. From there we can name the scope and the figure instead of guessing.',
        button: 'Send Brief',
      },
      schema: {
        serviceName: 'Occupational Safety Documentation and Reporting System Development',
      },
    },
    sistemInformasiKlinik: {
      title: 'Clinic Information System and Medical Record Integration',
      description: 'The system exists but visit data is not arriving, or medical records are still on paper. We handle the integration, the data migration, and the modules your system does not have.',
      kicker: 'Healthcare Facility System',
      hero: {
        title: 'The system already exists, <span class="ca-gradient-text">the connection does not</span>',
        subtitle: 'We start from what you already have, then work on the part that genuinely does not run. Replacing the whole system is something we recommend only when there is no other way, and we say why.',
        ctaPrimary: 'Free Consultation',
        ctaSecondary: 'View Portfolio',
        ctaTertiary: 'Read the Legal Basis',
      },
      problems: {
        title: 'What usually happens at facilities that already have a system',
        subtitle: 'This page is written for those who already bought a system, not for those who have nothing yet.',
        items: [
          { icon: 'lucide:plug-zap', title: 'Visit data never reaches its destination', description: 'The screen says the submission succeeded, but the data does not appear on the receiving side. Nobody can show the original error message.' },
          { icon: 'lucide:files', title: 'Medical records are still on paper', description: 'Files pile up, searching an old patient history takes time, and a lost copy cannot be restored.' },
          { icon: 'lucide:keyboard', title: 'Staff enter the same data twice', description: 'Once in your own system, once again in the insurer portal. The mismatch surfaces when a claim is rejected.' },
          { icon: 'lucide:puzzle', title: 'The module you need does not exist', description: 'Your workflow has a step the off-the-shelf vendor never considered, and your request never reaches their queue.' },
          { icon: 'lucide:database-backup', title: 'Switching systems means losing history', description: 'The previous vendor offers no complete export, so moving feels like starting from zero.' },
          { icon: 'lucide:clock', title: 'Queues build up at peak hours', description: 'Registration, calling, and recording happen in different places, so the queue is longer than the medical cause explains.' },
        ],
      },
      outcomes: {
        title: 'What changes once it is sorted out',
        subtitle: 'Without replacing the whole system, unless there really is no other way, and we will say so plainly.',
        items: [
          { icon: 'lucide:link', title: 'Every submission can be traced', description: 'Each submission is logged, failures included, with the reason. Failed ones can be resent without retyping.' },
          { icon: 'lucide:scan-line', title: 'History from the old system comes across', description: 'Data from the previous system is migrated and reconciled before and after the move. For archives still on paper, the scanning is done by another party and we handle the indexing and the import.' },
          { icon: 'lucide:repeat-2', title: 'One entry serves several destinations', description: 'The same data is not retyped for claims and for reporting.' },
          { icon: 'lucide:blocks', title: 'Missing modules can be added', description: 'What is not available yet is built alongside the system you already use, not in place of it.' },
          { icon: 'lucide:file-check-2', title: 'Supporting documents ready for review', description: 'Records and reports are stored complete with timestamps, so nothing has to be gathered at the last minute.' },
          { icon: 'lucide:shield', title: 'Access limited by role', description: 'Patient data opens only to those entitled to it, and every access is logged.' },
        ],
      },
      scope: {
        title: 'Scope of work',
        subtitle: 'We do not start by building. We start by reading what already runs.',
        items: [
          { icon: 'lucide:git-compare', title: 'Review of the running system', description: 'What exists, what is worth keeping, and which part is genuinely broken.' },
          { icon: 'lucide:plug', title: 'Integration work', description: 'Connecting to the destination system, including failure handling, resubmission, and an audit trail.' },
          { icon: 'lucide:database', title: 'Data migration', description: 'Moving data from the old system, with reconciliation before and after. Scanning paper archives is not our work, but we can index and import the scans.' },
          { icon: 'lucide:layout-panel-left', title: 'Additional modules', description: 'What the current system lacks, built to match the workflow already in place.' },
          { icon: 'lucide:users', title: 'Queue and registration', description: 'Registration, queue numbers, and calling that connect to visit records.' },
          { icon: 'lucide:file-lock', title: 'Access rights and audit trail', description: 'Role separation plus a record of who opened what and when.' },
        ],
      },
      regulation: {
        title: 'The regulations we rely on',
        subtitle: 'Every quotation below can be checked against the official document.',
        items: [
          {
            title: 'Hospital recording and reporting obligation',
            body: 'Article 74 paragraph (1) of Minister of Health Regulation Number 6 of 2026 on Hospitals states that every hospital must record and report all hospital operational activities in a Health Information System integrated with the National Health Information System.',
            sourceLabel: 'Permenkes 6 of 2026 at JDIH Kemkes',
            sourceUrl: 'https://jdih.kemkes.go.id/storage/documents/pdfs/2026permenkes006.pdf',
          },
          {
            title: 'Transition period',
            body: 'Article 83 letter a gives hospitals up to 2 years from promulgation to comply with the regulation, due 12 June 2028. Letter b gives up to 4 years for a class D pratama hospital that already holds a business licence, due 12 June 2030. Note that letter a covers the whole regulation, not the information system alone.',
            sourceLabel: 'Permenkes 6 of 2026 at JDIH Kemkes',
            sourceUrl: 'https://jdih.kemkes.go.id/storage/documents/pdfs/2026permenkes006.pdf',
          },
          {
            title: 'Sanctions applied in stages',
            body: 'Article 79 paragraph (1) states a breach of Article 74 paragraph (1) draws a verbal warning, a written warning, an administrative fine, adjustment or revocation of accreditation status, and revocation of the hospital business licence. The order is graduated. A verbal warning is issued at most once and a written warning at most twice before the next stage.',
            sourceLabel: 'Permenkes 6 of 2026 at JDIH Kemkes',
            sourceUrl: 'https://jdih.kemkes.go.id/storage/documents/pdfs/2026permenkes006.pdf',
          },
          {
            title: 'Clinics are not the subject of this regulation',
            body: 'Permenkes 6 of 2026 governs hospitals. The phrase in Article 83 letter b is class D pratama hospital, not pratama clinic. If your facility is a clinic, the basis for the obligation is different and we will not quote this regulation as if it applied to you. We look for the right reference together before the scope is locked.',
            sourceLabel: 'Permenkes 6 of 2026 at JDIH Kemkes',
            sourceUrl: 'https://jdih.kemkes.go.id/storage/documents/pdfs/2026permenkes006.pdf',
          },
        ],
        disclaimer: 'We name the National Health Information System rather than any platform brand, because that is what the regulation says. We also make no claim to be a registered electronic medical record provider at the Ministry of Health. If your procurement requires a registered provider, tell us at the start so you do not spend time on an option that cannot qualify.',
      },
      pricing: {
        title: 'Cost and duration range',
        subtitle: 'Integration work is the hardest to size from outside. What we can state now is the entry point and what moves your position inside the range.',
        headline: 'Integration, migration, or additional modules',
        range: 'From Rp 25 million',
        lowPrice: '25000000',
        duration: 'Delivery in 4 to 12 weeks',
        note: 'The entry point and duration above follow the Web App Custom package already published on our website development page. The upper bound depends on the final scope and is written into the proposal before work begins.',
        ...
        factorsTitle: 'What decides your position inside the range',
        factors: [
          { icon: 'lucide:file-search', title: 'Documentation of the existing system', description: 'A system with interface documentation is far faster to connect than one that has to be read from its behaviour.' },
          { icon: 'lucide:database', title: 'Volume and condition of the data', description: 'The number of medical records and how tidy they are decides how long migration and reconciliation take.' },
          { icon: 'lucide:handshake', title: 'Whether the previous vendor grants access', description: 'If the data export has to be requested from another party, their timeline decides the schedule, not ours.' },
          { icon: 'lucide:layers', title: 'Number of modules added', description: 'One standalone module is not the same as several that depend on each other.' },
          { icon: 'lucide:building-2', title: 'Number of service units', description: 'A single-site clinic is not the same as a hospital with many units and a different flow per unit.' },
          { icon: 'lucide:file-text', title: 'Reporting requirements', description: 'Several report formats maintained side by side add testing work.' },
        ],
      },
      caseStudy: {
        kicker: 'Before you read further',
        title: 'We have not built a healthcare facility system before',
        sector: 'Stated plainly',
        description: 'Our portfolio register holds no clinic or hospital project. Presenting a case study that never happened costs you more than it costs us, so this section carries the real work that sits closest to what this page is about.',
        points: [
          'Tenant data separation at the database schema level in our own product',
          'A document portal that opens without an account, with a snapshot frozen at issue time',
          'A delivery record for every call to a third-party service, including failures and their response codes',
        ],
        note: 'If your institution scores healthcare sector experience as a requirement, we are not the right fit, and you deserve to know that now.',
        ctaLabel: 'See the full portfolio',
      },
      related: {
        title: 'Other pages you may need',
        subtitle: 'If your need sits outside healthcare, these three are closer.',
        items: [
          { icon: 'lucide:hard-hat', title: 'Safety reporting and documentation system', description: 'For occupational safety reporting duties and safety training providers.', to: '/layanan/sistem-pelaporan-k3' },
          { icon: 'lucide:receipt', title: 'Transaction and operations system', description: 'For orders, invoicing, and stock figures that never reconcile.', to: '/layanan/sistem-manajemen-transaksi' },
          { icon: 'lucide:layout-dashboard', title: 'Web application development', description: 'The general page for internal systems outside these three categories.', to: '/layanan/jasa-pembuatan-aplikasi-web' },
        ],
      },
      faq: {
        title: 'Questions that come up often',
        items: [
          { question: 'We are registered but our data does not arrive, why?', answer: 'Three things we check first: the submission shape does not match what the receiver expects, the patient identifier is incomplete, and failures are never surfaced to staff so nobody knows to retry. All three can only be confirmed after reading the submission trail.' },
          { question: 'Does the current system have to be thrown away?', answer: 'Not always, and that is not a decision we make before seeing it. If daily recording is in use and causing no trouble, replacing everything only adds risk. Usually only the part that does not run needs work.' },
          { question: 'Does CoreAsia scan paper medical records?', answer: 'No. Scanning archives is not our work and we do not sell it. What we do is index and import the scans into the system, and set the rule on which source prevails while the paper archive and the new system run side by side. The order in which records move is decided by you and your clinical team.' },
          { question: 'How long does an integration take?', answer: 'It depends on the availability of interface documentation and how quickly the receiving side responds. The part we control is usually not the longest part. We give a time estimate after reading the submission trail you have today.' },
          { question: 'Is CoreAsia a registered electronic medical record provider?', answer: 'We make no claim to that status. If your procurement requires a registered provider, say so at the start so the scope and eligibility are clear before you spend time.' },
          { question: 'Does the new hospital regulation apply to clinics?', answer: 'No. Permenkes 6 of 2026 governs hospitals. Article 83 letter b names class D pratama hospitals, not pratama clinics. For clinics the basis has to be found separately, and we will not use this regulation as an argument.' },
          { question: 'How is patient data protected?', answer: 'Access is limited per role, every data access is logged, and data moves over encrypted channels. Additional rules that apply at your facility are followed and written into the agreement before work begins.' },
        ],
      },
      cta: {
        title: 'Send us one failed submission you hit',
        subtitle: 'An error screenshot or the submission log is enough for us to name the likely cause and the scope of work.',
        button: 'Send Brief',
      },
      schema: {
        serviceName: 'Healthcare Facility Information System Development and Integration',
      },
    },
    sistemManajemenTransaksi: {
      title: 'Transaction and Operations Management System',
      description: 'Orders arrive in chat, the recap lives in a spreadsheet, and the figure never matches the warehouse. We build a transaction system that follows how your team works.',
      kicker: 'Transaction System',
      hero: {
        title: 'Orders from chat become <span class="ca-gradient-text">records you can trust</span>',
        subtitle: 'Your team does not have to stop using a messaging app. What has to change is what happens after the order arrives.',
        ctaPrimary: 'Free Consultation',
        ctaSecondary: 'View Portfolio',
        ctaTertiary: 'See the Cost Range',
      },
      problems: {
        title: 'What usually happens at the end of the month',
        subtitle: 'This page is written for those who already tried an off-the-shelf app and then stopped using it.',
        items: [
          { icon: 'lucide:message-circle-off', title: 'Orders slip between other messages', description: 'Orders arrive mixed with questions and small talk. The one that got missed surfaces when the buyer chases it.' },
          { icon: 'lucide:file-spreadsheet', title: 'The daily recap is retyped from chat', description: 'Someone spends part of every day copying chat into a spreadsheet. Typos travel with it and nobody checks.' },
          { icon: 'lucide:scale', title: 'Sales figures do not match stock', description: 'Sales are recorded in one place, goods leaving in another. The gap appears at the physical count.' },
          { icon: 'lucide:receipt-text', title: 'Payment proof disappears in chat', description: 'A transfer receipt is sent and then buried. When the invoice is chased, nobody can show whether it was paid.' },
          { icon: 'lucide:copy', title: 'The team works twice', description: 'An app exists, yet the team keeps a private spreadsheet because the app does not follow how they work.' },
          { icon: 'lucide:file-clock', title: 'Nothing guards staged billing', description: 'The second and third instalment slip because nothing but human memory tracks them.' },
        ],
      },
      outcomes: {
        title: 'What changes once it is sorted out',
        subtitle: 'Without forcing customers onto a different channel and without replacing every system at once.',
        items: [
          { icon: 'lucide:inbox', title: 'Orders have one place to land', description: 'Wherever the order comes from, the record ends up in one place with a number, a status, and an owner.' },
          { icon: 'lucide:refresh-cw', title: 'Sales and stock move from one event', description: 'Goods leaving are recorded because the order changed status, not because someone remembered to log it.' },
          { icon: 'lucide:bell', title: 'Instalments and due dates remind themselves', description: 'What is not due yet, what is overdue, and what is paid are visible without searching.' },
          { icon: 'lucide:workflow', title: 'Internal approvals leave a trail', description: 'Who approved what and when is recorded, so nobody has to ask who made the call.' },
          { icon: 'lucide:eye', title: 'One number for everyone', description: 'No more two versions of the recap between sales and the warehouse.' },
          { icon: 'lucide:message-square', title: 'The messaging app can stay', description: 'The entry point is not forced to change. Only where the record ends up changes.' },
        ],
      },
      scope: {
        title: 'Scope of work',
        subtitle: 'The first stage is deliberately small. What matters is that one class of mistake stops happening.',
        items: [
          { icon: 'lucide:clipboard-list', title: 'Order records', description: 'Order number, customer, contents, status, and change history.' },
          { icon: 'lucide:package', title: 'Stock and outbound goods', description: 'Stock movement tied to order events, including manual adjustments that stay on the record.' },
          { icon: 'lucide:receipt', title: 'Invoicing and payment', description: 'Invoices, instalments, paid marking, and payment proof stored against the order.' },
          { icon: 'lucide:check-check', title: 'Approval flow', description: 'Internal approval steps that follow the rules already in force at your company.' },
          { icon: 'lucide:bar-chart-3', title: 'Recaps and reports', description: 'Daily and monthly recaps plus exports for bookkeeping.' },
          { icon: 'lucide:key-round', title: 'Roles and access rights', description: 'Separate access for sales, warehouse, finance, and the owner.' },
        ],
      },
      pricing: {
        title: 'Cost and duration range',
        subtitle: 'The exact figure follows a locked scope. What we can state now is the entry point and what moves your position inside the range.',
        headline: 'Transaction and operations system',
        range: 'From Rp 25 million',
        lowPrice: '25000000',
        duration: 'Delivery in 4 to 12 weeks',
        note: 'The entry point and duration above follow the Web App Custom package already published on our website development page. The upper bound depends on the final scope and is written into the proposal before work begins.',
        ...
        factorsTitle: 'What decides your position inside the range',
        factors: [
          { icon: 'lucide:git-branch', title: 'Number of order channels', description: 'A single order channel is not the same as orders arriving from several channels at once.' },
          { icon: 'lucide:package', title: 'Whether physical stock is involved', description: 'A service business needs no stock movement, and that removes a large part of the work.' },
          { icon: 'lucide:credit-card', title: 'How payment is accepted', description: 'Marking an invoice paid by hand is simpler than connecting to a payment provider licensed by Bank Indonesia.' },
          { icon: 'lucide:users-round', title: 'Roles and approval steps', description: 'The more steps an order must pass, the more there is to test.' },
          { icon: 'lucide:file-input', title: 'Condition of the data to migrate', description: 'A consistent spreadsheet moves faster than files whose shape changes every month.' },
          { icon: 'lucide:plug', title: 'Connections to other systems', description: 'Connecting to the bookkeeping or shipping system you already use adds work.' },
        ],
      },
      caseStudy: {
        kicker: 'Case Study',
        title: 'Multi-workspace sales system',
        sector: 'Sales and business operations sector',
        description: 'We built a sales system covering the deal pipeline, quotations, invoices, a document portal customers open without an account, per-role data scope, and payment. It is our own product rather than commissioned client work, and it runs in production. A single deployment holds many workspaces, with data separated at the database schema level.',
        points: [
          'Deal pipeline with configurable stages',
          'Quotations and invoices rendered to PDF on the server',
          'Account-free document portal for approval and payment proof upload',
          'Payment through a provider licensed by Bank Indonesia',
        ],
        note: 'What matters here: the hard part is not building an order form, it is keeping one number the same across the system while many people change it at once.',
        ctaLabel: 'See the full portfolio',
      },
      related: {
        title: 'Other pages you may need',
        subtitle: 'If your problem is not transactions after all, these three are closer.',
        items: [
          { icon: 'lucide:hard-hat', title: 'Safety reporting and documentation system', description: 'For occupational safety reporting duties and safety training providers.', to: '/layanan/sistem-pelaporan-k3' },
          { icon: 'lucide:stethoscope', title: 'Clinic and medical record system', description: 'For healthcare facilities whose system exists but is not connected yet.', to: '/layanan/sistem-informasi-klinik' },
          { icon: 'lucide:globe', title: 'Website development', description: 'If what you need first is a public page rather than an internal system.', to: '/layanan/jasa-pembuatan-website' },
        ],
      },
      faq: {
        title: 'Questions that come up often',
        items: [
          { question: 'We tried an off-the-shelf app and it did not fit, what went wrong?', answer: 'Usually not the app. Off-the-shelf apps are built from an average workflow, while what keeps your business running is often the step that is not average. When the two collide, the team picks the faster route and the system is abandoned.' },
          { question: 'Do we have to replace every system at once?', answer: 'No, and we do not recommend it. What works most often is taking the one part that causes the most mistakes, fixing it, then checking whether the next part still needs work at all.' },
          { question: 'What if the team wants to keep taking orders in a messaging app?', answer: 'That is fine. Forcing customers onto another channel is the fastest way to lose orders. What we tidy up is what happens after the order is received, not how customers reach you.' },
          { question: 'How much should the first stage cover?', answer: 'Enough to stop the single most frequent class of mistake. If the first stage already touches five areas at once, the scope usually needs cutting again.' },
          { question: 'Can spreadsheet data be migrated?', answer: 'Yes, as long as the columns are consistent. Files whose shape changes every month need tidying first, and that is separate work we list separately in the proposal.' },
          { question: 'Can the system accept payments?', answer: 'Yes, through a payment provider licensed by Bank Indonesia. Registration and the agreement with that provider are in your own business name, not ours.' },
          { question: 'Who owns the source code?', answer: 'The source code becomes fully yours once the project is complete and payment is settled.' },
        ],
      },
      cta: {
        title: 'Tell us about one order that slipped this month',
        subtitle: 'One real example is more useful than a requirements list. From there we can point at the part to fix first.',
        button: 'Send Brief',
      },
      schema: {
        serviceName: 'Transaction and Operations Management System Development',
      },
    },
  },
  blog: {
  ...
  portfolio: {
    ...
    description: 'See the CoreAsia project portfolio: a training and certification system built for a client, a sales CRM, a website monitoring dashboard, desktop apps, and the company site.',
    kicker: 'Portfolio',
    heading: 'Projects We Have Built',
    subtitle: 'From concept to production. The first three carry written case studies where every figure can be traced to a file or a live request; the rest are products we build and run ourselves.',
    items: [
      {
        title: 'Occupational Safety Training and Certification System',
        category: 'Third-Party Client',
        description: 'A public website and an operations console for an occupational safety and health training and certification provider. Prospective participants read the training catalogue and class schedule and register straight from the site, while the provider handles registrations, sales through to invoices, articles, and galleries from a single console with access rights set per user. What we name here is the sector, not the institution.',
        highlights: ['The sitemap grew from 11 pages when search monitoring was set up to 150 pages today', 'The catalogue and articles are edited by the provider through the console, with no code change needed', 'Page copying by another domain was answered with three protective layers and a copyright report', 'Connections to the site are forced over encryption and page content is limited to approved sources'],
        meta: ['Development activity December 2025 to June 2026', 'Built by one developer', 'Evidence re-checked 7 September 2026'],
      },
      {
        title: 'LeadKu by CoreAsia',
        category: 'SaaS Product',
        description: 'A sales CRM that holds many workspaces at once. One place to run the sales pipeline, issue quotes and invoices, share documents with clients through an account-free link, limit what each role can see, and ask a sales assistant named Leo about the pipeline. Every customer company keeps its own data, with nothing shared between them.',
        link: 'https://leadku.coreasia.id',
        highlights: ['Every customer company keeps its own separate data space', 'Sales assistant answers appear as they are written, without waiting for the full reply', 'Quotes and invoices come out as PDFs ready to send', 'Subscriptions are paid through a Bank Indonesia licensed payment provider'],
        meta: ['Development activity March to August 2026', 'Built by one developer', 'Evidence re-checked 7 September 2026'],
      },
      {
        title: 'Pantau by CoreAsia',
        category: 'SaaS Product',
        description: 'A website monitoring dashboard that brings visitor data, search results, keyword rankings, SEO checks, a question and answer assistant, and scheduled PDF reports onto one screen. Used to review how a site is performing without moving between tools.',
        link: 'https://pantau.coreasia.id',
        highlights: ['Visitor, search, and page speed data pulled straight from the official sources', 'Page speed scores stored as history, not just the current number', 'Recurring PDF reports publish themselves on the schedule you set', 'Fully bilingual interface, 2,105 text keys per language'],
        meta: ['Development activity March to August 2026', 'Built by one developer', 'Evidence re-checked 7 September 2026'],
      },
      {
        title: 'CoreAsia Downloader',
        category: 'Desktop App',
        description: 'A desktop app for saving video and audio from video sharing sites. Paste the link, or let the browser companion find the media on the page you have open. Pick the resolution or take the audio alone, then the download runs in a queue you can walk away from.',
        link: 'https://coreasia.id/products/downloader',
        highlights: ['Downloads run side by side and survive closing the app', 'Resolution and subtitle files are chosen before the download starts', 'The browser companion sends detected media straight to the app', 'Licences are checked on the server, not only on the buyer machine'],
        meta: ['Used by individuals, installed on their own computer', 'Available for macOS, the Windows build is in beta', 'Free to try for three days before buying'],
      },
      {
        title: 'CoreAsia Mounter',
        category: 'Desktop App',
        description: 'A small macOS menu-bar utility that makes NTFS drives writable on Apple Silicon Macs. A drive is recognised and ready as soon as it is plugged in, with nothing extra installed into the operating system and no lowering of the Mac security settings.',
        link: 'https://coreasia.id/products/mounter',
        highlights: ['The Mac security settings stay untouched', 'Drives are recognised and mounted on their own when plugged in', 'The part that needs elevated rights is kept apart from the app', 'Reading a drive is free, writing is unlocked by a licence'],
        meta: ['Used by individuals on Apple Silicon Macs', 'Reading free forever, writing paid once with no subscription', 'Writing can be tried free for one day'],
      },
      {
        title: 'CoreAsia Beres',
        category: 'SaaS Product',
        description: 'Four browser-based tools for tidying up files and number lists. Photo and PDF compression are free with no account. BerkasKilat resizes a complete set of CPNS, SNBT, and SPMB application files using official institution presets, while RapiKontak normalises phone number lists to the 62 format and drops duplicates and invalid entries.',
        link: 'https://tools.coreasia.id',
        highlights: ['Two free tools with no usage limit', 'Paid once by scanning a payment code, no account and no subscription', 'Files are deleted automatically once processing finishes'],
        meta: ['Used by entrance exam applicants, sellers, and group admins', 'Runs in the browser, nothing to install', 'Two tools free and two paid once'],
      },
      {
        title: 'CoreAsia Landing & CMS',
        category: 'Company Website',
        description: 'The CoreAsia company site itself, including the product pages, service pages, and articles. Page content is written and published from the operations console in two languages, so the text you are reading now can be replaced without waiting for a code change.',
        highlights: ['Every page is available in Indonesian and English', 'Articles are written and published through the editor in the console', 'Each page carries structured data so search engines can read it', 'Pages open quickly because part of the site is prepared before it is requested'],
        meta: ['CoreAsia own site, not client commissioned work', 'Live at coreasia.id, this page is part of it', 'Open to the public, no account needed'],
      },
    ],
  ...
  components: {
    ...
    footer: {
      ...
      serviceLinks: [
        ...
        { label: 'Safety Reporting System', to: '/layanan/sistem-pelaporan-k3' },
        { label: 'Clinic Information System', to: '/layanan/sistem-informasi-klinik' },
        { label: 'Transaction Management System', to: '/layanan/sistem-manajemen-transaksi' },
      ],
    },
    liveTicker: {
      stats: [
