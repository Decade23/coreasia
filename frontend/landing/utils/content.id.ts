const ID_CONTENT = {
  ...
  home: {
    ...
    services: {
      ...
      items: [
        ...
        { label: 'Sistem Pelaporan K3', description: 'Rekap kejadian, notulen rapat P2K3, dan bukti inspeksi yang siap jadi laporan berkala.', to: '/layanan/sistem-pelaporan-k3' },
        { label: 'Sistem Informasi Klinik', description: 'Integrasi, migrasi rekam medis, dan modul tambahan untuk fasilitas kesehatan.', to: '/layanan/sistem-informasi-klinik' },
        { label: 'Sistem Manajemen Transaksi', description: 'Pesanan, penagihan, dan stok yang catatannya akhirnya cocok satu sama lain.', to: '/layanan/sistem-manajemen-transaksi' },
      ],
    },
    readyCTA: {
  ...
  contact: {
    ...
    form: {
      ...
      subtitle: 'Ceritakan kebutuhan Anda secara singkat. Brief disimpan lebih dahulu, lalu Anda bisa lanjut ke WhatsApp bila ingin dibalas lebih cepat.',
      fields: {
        name: 'Nama lengkap',
        email: 'Email',
        phone: 'No. WhatsApp',
      ...
      successTitle: 'Brief Anda terkirim',
      successBody: 'Brief sudah kami terima dan masuk antrean tim. Kami membalas pada jam kerja, Senin sampai Jumat pukul 09.00 sampai 17.00 WIB. Ingin lebih cepat, lanjutkan saja di WhatsApp.',
  ...
  services: {
    ...
    sistemPelaporanK3: {
      title: 'Sistem Pelaporan P2K3 dan Dokumentasi K3',
      description: 'Rekap kecelakaan kerja, notulen rapat P2K3, dan bukti inspeksi tersimpan di satu tempat dan siap jadi laporan berkala untuk Disnaker. Dibangun mengikuti format yang sudah kamu pakai.',
      kicker: 'Sistem Dokumentasi K3',
      hero: {
        title: 'Laporan P2K3 berhenti disusun <span class="ca-gradient-text">dari awal setiap kali</span>',
        subtitle: 'Catatan kejadian ada di grup pesan, notulen rapat ada di berkas pengolah kata, foto inspeksi ada di ponsel petugas. Kami rapikan jadi satu tempat yang isinya sudah berbentuk laporan sebelum kamu memintanya.',
        ctaPrimary: 'Konsultasi Gratis',
        ctaSecondary: 'Lihat Portofolio',
        ctaTertiary: 'Baca Dasar Aturannya',
      },
      problems: {
        title: 'Yang biasanya terjadi menjelang tenggat laporan',
        subtitle: 'Kalau tiga dari enam hal ini kamu kenali, masalahnya bukan pada ketelitian orangnya.',
        items: [
          { icon: 'lucide:message-square-warning', title: 'Kejadian dilaporkan di grup pesan', description: 'Insiden dilaporkan lewat obrolan, lalu tertimbun pesan lain di hari yang sama. Saat direkap berbulan kemudian, tanggal dan kronologinya sudah harus ditebak.' },
          { icon: 'lucide:folder-search', title: 'Notulen rapat tersebar di banyak folder', description: 'Setiap sekretaris menyimpan dengan pola penamaan sendiri. Mencari notulen rapat bulan tertentu jadi pekerjaan setengah hari.' },
          { icon: 'lucide:image-off', title: 'Foto inspeksi berhenti di ponsel petugas', description: 'Bukti visual temuan ada, tapi tidak menempel pada temuannya. Saat laporan disusun, fotonya tidak lagi bisa dipasangkan ke butir mana.' },
          { icon: 'lucide:file-spreadsheet', title: 'Rekap dikerjakan ulang tiap periode', description: 'Berkas rekap disalin dari periode sebelumnya lalu diedit. Kesalahan periode lama ikut tersalin dan baru ketahuan saat diperiksa.' },
          { icon: 'lucide:user-x', title: 'Sekretaris berganti dan arsipnya ikut pergi', description: 'Riwayat dokumen menempel pada orang, bukan pada perusahaan. Pengurus baru mulai dari nol.' },
          { icon: 'lucide:map-pin-off', title: 'Laporan yang sama disusun ulang untuk tiap dinas', description: 'Formatnya satu, mengikuti Lampiran Permenaker 13 Tahun 2025, tetapi tujuannya Kepala Dinas Daerah Provinsi di tiap lokasi. Perusahaan dengan banyak lokasi menyusun laporan berulang kali dari sumber data yang sama.' },
        ],
      },
      outcomes: {
        title: 'Yang berubah setelah dibereskan',
        subtitle: 'Bukan menambah pekerjaan administrasi. Memindahkan pencatatan ke tempat yang bentuk keluarannya memang sudah laporan.',
        items: [
          { icon: 'lucide:clipboard-check', title: 'Laporan tinggal ditinjau, bukan disusun', description: 'Data masuk sekali saat kejadian dicatat. Periode pelaporan hanya soal memilih rentang tanggal lalu memeriksa isinya.' },
          { icon: 'lucide:smartphone', title: 'Temuan dicatat dari lokasi', description: 'Petugas mengisi temuan dan melampirkan foto dari ponsel saat inspeksi berlangsung, bukan mengetik ulang setibanya di kantor.' },
          { icon: 'lucide:history', title: 'Riwayat tetap ada saat orangnya berganti', description: 'Notulen, daftar hadir, dan tindak lanjut menempel pada perusahaan. Pengurus baru membuka arsip yang sama.' },
          { icon: 'lucide:list-checks', title: 'Tindak lanjut punya penanggung jawab dan tenggat', description: 'Temuan inspeksi tidak berhenti sebagai catatan. Setiap butir punya pemilik dan status yang terlihat.' },
          { icon: 'lucide:download', title: 'Keluaran mengikuti format resminya', description: 'Berkas ekspor disusun mengikuti Lampiran Permenaker 13 Tahun 2025 dan bisa dipisah per lokasi kerja, supaya tiap dinas provinsi menerima laporan lokasinya sendiri.' },
          { icon: 'lucide:shield-check', title: 'Siap diperiksa tanpa persiapan mendadak', description: 'Saat pemeriksaan datang, dokumen pendukung sudah lengkap dan bertanggal, bukan dikumpulkan semalam sebelumnya.' },
        ],
      },
      scope: {
        title: 'Ruang lingkup pekerjaan',
        subtitle: 'Dikerjakan bertahap. Bagian yang paling sering dipakai dibangun lebih dulu supaya bisa dipakai sebelum seluruh sistem selesai.',
        items: [
          { icon: 'lucide:file-plus', title: 'Pencatatan kejadian dan nyaris celaka', description: 'Formulir pencatatan insiden dengan kronologi, lokasi, korban, tindakan yang diambil, dan lampiran bukti.' },
          { icon: 'lucide:users', title: 'Rapat dan keanggotaan P2K3', description: 'Jadwal rapat, daftar hadir, notulen, dan keputusan rapat yang bisa ditelusuri per periode.' },
          { icon: 'lucide:clipboard-list', title: 'Inspeksi dan temuan', description: 'Daftar periksa inspeksi yang bisa kamu susun sendiri, hasil temuan, foto, dan tindak lanjut berpenanggung jawab.' },
          { icon: 'lucide:file-output', title: 'Rekap dan ekspor laporan', description: 'Rekap per periode dan berkas ekspor yang bentuknya mengikuti Lampiran Permenaker 13 Tahun 2025, dipisah per lokasi kerja bila diperlukan.' },
          { icon: 'lucide:graduation-cap', title: 'Berkas peserta pelatihan dan sertifikat', description: 'Untuk lembaga pelatihan K3: pendaftaran peserta, kelengkapan berkas, penerbitan dan pengiriman sertifikat.' },
          { icon: 'lucide:key-round', title: 'Peran dan hak akses', description: 'Pembedaan akses antara pengurus P2K3, petugas lapangan, dan manajemen, termasuk untuk perusahaan dengan banyak lokasi.' },
        ],
      },
      regulation: {
        title: 'Dasar aturan yang kami pakai',
        subtitle: 'Setiap klaim di bawah bisa kamu periksa sendiri pada dokumen resminya. Kami tidak mengutip ringkasan pihak ketiga.',
        items: [
          {
            title: 'Kewajiban membentuk P2K3',
            body: 'Pasal 3 ayat (2) Peraturan Menteri Ketenagakerjaan Nomor 13 Tahun 2025 mewajibkan pembentukan P2K3 bagi tempat kerja atau perusahaan yang mempekerjakan pekerja paling sedikit 100 orang, atau yang mempunyai tingkat risiko tinggi. Dasar induknya Pasal 10 Undang-Undang Nomor 1 Tahun 1970 tentang Keselamatan Kerja.',
            sourceLabel: 'Permenaker 13 Tahun 2025 di JDIH Kemnaker',
            sourceUrl: 'https://jdih.kemnaker.go.id/peraturan/detail/2788/peraturan-menteri-ketenagakerjaan-nomor-13-tahun-2025',
            sourceLabel2: 'UU Nomor 1 Tahun 1970 di JDIH BPK',
            sourceUrl2: 'https://peraturan.bpk.go.id/Details/47614/uu-no-1-tahun-1970',
          },
          {
            title: 'Pelaporan berkala yang disampaikan secara elektronik',
            body: 'Pasal 11 ayat (1) mewajibkan ketua P2K3 menyampaikan pelaporan kegiatan secara berkala satu kali setiap enam bulan, atau sewaktu-waktu apabila diperlukan. Ayat (2) menyatakan pelaporan itu disampaikan secara elektronik melalui sistem informasi yang dikelola Kementerian Ketenagakerjaan, dan ayat (3) memperbolehkan cara manual selama sistem itu belum tersedia.',
            sourceLabel: 'Permenaker 13 Tahun 2025 di JDIH Kemnaker',
            sourceUrl: 'https://jdih.kemnaker.go.id/peraturan/detail/2788/peraturan-menteri-ketenagakerjaan-nomor-13-tahun-2025',
          },
          {
            title: 'Tenggat 19 November 2026',
            body: 'Pasal 15 menyatakan sistem informasi pelaporan itu harus terbentuk paling lama satu tahun terhitung sejak peraturan diundangkan. Peraturan ini diundangkan 19 November 2025, sehingga tenggatnya jatuh pada 19 November 2026. Perusahaan yang catatannya masih tersebar akan kesulitan mengisi apa pun bentuk sistemnya nanti.',
            sourceLabel: 'Permenaker 13 Tahun 2025 di JDIH BPK',
            sourceUrl: 'https://peraturan.bpk.go.id/Details/342991/permenaker-no-13-tahun-2025',
          },
          {
            title: 'Pemeriksaan mandiri berbasis website',
            body: 'Pasal 49 ayat (1) Peraturan Menteri Ketenagakerjaan Nomor 11 Tahun 2026 menyebut pengembangan sistem pengawasan dapat dilakukan melalui pemeriksaan norma ketenagakerjaan secara mandiri oleh perusahaan berbasis website, yang hasilnya diverifikasi pengawas ketenagakerjaan. Kata yang dipakai peraturan adalah dapat, bukan wajib, dan pemicunya ada di sisi pengawas.',
            sourceLabel: 'Permenaker 11 Tahun 2026 di JDIH Kemnaker',
            sourceUrl: 'https://jdih.kemnaker.go.id/peraturan/detail/3070/peraturan-menteri-ketenagakerjaan-nomor-11-tahun-2026',
          },
        ],
        disclaimer: 'Dua hal yang tidak kami pakai sebagai alasan. Pertama, PER.04/MEN/1987 yang masih banyak dikutip sebagai dasar P2K3 sudah dicabut dan dinyatakan tidak berlaku oleh Pasal 16 Permenaker 13 Tahun 2025. Kedua, Bulan K3 Nasional adalah petunjuk pelaksanaan kegiatan, bukan kewajiban digitalisasi, jadi kami tidak menjadikannya alasan untuk membeli apa pun.',
      },
      pricing: {
        title: 'Rentang biaya dan durasi',
        subtitle: 'Angka pastinya keluar setelah lingkup dikunci. Yang bisa kami sebutkan sekarang adalah titik masuk dan hal yang menggerakkan posisimu di dalam rentang.',
        headline: 'Sistem internal berbasis web',
        range: 'Mulai Rp 25 juta',
        lowPrice: '25000000',
        duration: 'Pengerjaan 4 sampai 12 minggu',
        note: 'Titik masuk dan durasi di atas mengikuti paket Web App Custom yang sudah kami cantumkan pada halaman jasa pembuatan website. Batas atasnya ditentukan lingkup akhir dan ditulis pada penawaran sebelum pengerjaan dimulai.',
        noteLinkLabel: 'Periksa paket Web App Custom di halaman jasa pembuatan website',
        noteLinkTo: '/layanan/jasa-pembuatan-website#paket-harga',
        factorsTitle: 'Yang menentukan posisimu di dalam rentang',
        factors: [
          { icon: 'lucide:building', title: 'Jumlah lokasi kerja', description: 'Satu lokasi berbeda dengan enam lokasi, karena tiap lokasi punya laporan dan dinas tujuannya sendiri, sehingga datanya harus terpisah sejak dicatat.' },
          { icon: 'lucide:users-round', title: 'Jumlah peran dan pengguna', description: 'Semakin banyak pembedaan hak akses, semakin banyak yang harus diuji sebelum sistemnya dipakai.' },
          { icon: 'lucide:file-input', title: 'Kondisi data lama', description: 'Arsip yang sudah rapi di lembar sebar lebih murah dipindahkan daripada arsip campuran kertas dan foto.' },
          { icon: 'lucide:plug', title: 'Sambungan ke sistem lain', description: 'Menarik data karyawan dari sistem kepegawaian yang sudah ada menambah pekerjaan dibandingkan pengisian mandiri.' },
          { icon: 'lucide:smartphone', title: 'Pemakaian di lapangan', description: 'Pengisian dari ponsel saat inspeksi menuntut penanganan yang berbeda dari pengisian di meja kerja.' },
          { icon: 'lucide:file-check-2', title: 'Bentuk keluaran yang diminta', description: 'Satu format ekspor berbeda dengan beberapa format yang harus dijaga bersamaan.' },
        ],
      },
      caseStudy: {
        kicker: 'Studi Kasus',
        title: 'Sistem manajemen pelatihan untuk penyelenggara pelatihan K3',
        sector: 'Klien di luar CoreAsia, berjalan di produksi',
        description: 'Pendaftaran dari situs publik masuk langsung ke administrasi dengan kode pendaftarannya sendiri, berkas kelengkapan peserta menempel pada pendaftaran itu, dan setiap perubahan status tersimpan lengkap dengan siapa yang mengubahnya. Jadwal pelatihan, isi situs, dan hak akses tiap peran dikelola dari satu tempat yang sama.',
        points: [
          'Pendaftaran dari situs publik masuk ke administrasi tanpa disalin ulang',
          'Berkas kelengkapan peserta menempel pada pendaftarannya',
          'Perubahan status pendaftaran tercatat beserta pengubahnya',
          'Peran dan hak akses diatur sendiri oleh pengelola',
        ],
        note: 'Dua hal yang perlu kamu tahu sejak awal. Yang kami sebut di sini sektornya, bukan nama lembaganya. Dan sistem pelaporan P2K3 itu sendiri belum pernah kami kerjakan untuk klien, jadi yang sudah terbukti di sini adalah pengelolaan peserta, kelengkapan berkas, dan jejak perubahannya.',
        ctaLabel: 'Lihat portofolio lengkap',
      },
      related: {
        title: 'Halaman lain yang mungkin kamu butuhkan',
        subtitle: 'Kalau masalahmu ternyata bukan dokumentasi K3, tiga halaman ini lebih dekat.',
        items: [
          { icon: 'lucide:receipt', title: 'Sistem manajemen transaksi dan operasional', description: 'Untuk pesanan dan penagihan yang berantakan, bukan dokumentasi kepatuhan.', to: '/layanan/sistem-manajemen-transaksi' },
          { icon: 'lucide:stethoscope', title: 'Sistem informasi klinik dan rekam medis', description: 'Untuk fasilitas kesehatan yang sistemnya sudah ada tapi belum tersambung.', to: '/layanan/sistem-informasi-klinik' },
          { icon: 'lucide:layout-dashboard', title: 'Jasa pembuatan aplikasi web', description: 'Halaman umum untuk sistem internal yang tidak masuk tiga kategori di atas.', to: '/layanan/jasa-pembuatan-aplikasi-web' },
        ],
      },
      faq: {
        title: 'Pertanyaan yang sering muncul',
        items: [
          { question: 'Berapa kali laporan kegiatan P2K3 harus disampaikan?', answer: 'Pasal 11 ayat (1) Permenaker 13 Tahun 2025 menyebut pelaporan disampaikan secara berkala satu kali setiap enam bulan, atau sewaktu-waktu apabila diperlukan. Kalau selama ini kamu melapor setiap tiga bulan, kemungkinan itu mengikuti kebiasaan lama atau permintaan dinas setempat. Sistemnya tetap kami siapkan supaya bisa mengikuti keduanya.' },
          { question: 'Perusahaan kami di bawah 100 karyawan, apakah tetap wajib punya P2K3?', answer: 'Pasal 3 ayat (2) memasang dua kriteria yang bersifat pilihan: mempekerjakan pekerja paling sedikit 100 orang, atau mempunyai tingkat risiko tinggi. Ayat (3) menyatakan penentuan tingkat risiko tinggi mengikuti peraturan perizinan berusaha. Jadi jumlah karyawan bukan satu-satunya penentu.' },
          { question: 'Kami sudah pakai lembar sebar, apa perlu sistem?', answer: 'Kalau berkasnya dipegang satu orang dan jarang diubah, lembar sebar masih cukup dan kami tidak akan menyuruhmu mengganti sesuatu yang masih bekerja. Yang biasanya menjadi masalah adalah saat pengisinya lebih dari satu, saat butuh lampiran foto, dan saat riwayat perubahan perlu ditelusuri.' },
          { question: 'Apakah data lama bisa dipindahkan?', answer: 'Bisa, sepanjang datanya masih terbaca. Arsip di lembar sebar dipindahkan lebih cepat. Arsip kertas dan foto perlu ditentukan lebih dulu mana yang benar-benar perlu masuk, karena memindahkan semuanya jarang sepadan dengan biayanya.' },
          { question: 'Apakah CoreAsia menyediakan tenaga Ahli K3?', answer: 'Tidak. Kami membangun sistemnya, bukan menyediakan personel maupun jasa sertifikasi. Pasal 5 ayat (3) Permenaker 13 Tahun 2025 mensyaratkan sekretaris P2K3 merupakan Ahli K3 yang telah ditunjuk, dan itu di luar layanan kami.' },
          { question: 'Apakah sistem ini otomatis mengirim ke portal Disnaker?', answer: 'Tidak, dan kami tidak menjanjikannya. Pasal 11 ayat (2) Permenaker 13 Tahun 2025 menyebut pelaporan disampaikan lewat sistem informasi yang dikelola Kementerian Ketenagakerjaan, dan Pasal 15 memberi tenggat sampai 19 November 2026 untuk sistem itu terbentuk. Selama jalur kirimnya belum terbuka untuk sistem luar, yang kami siapkan adalah keluaran yang bentuknya mengikuti Lampiran peraturan itu dan siap kamu kirim ke dinas provinsi tujuan.' },
          { question: 'Berapa lama sampai bisa dipakai?', answer: 'Bagian pencatatan biasanya bisa dipakai lebih dulu, sementara rekap dan ekspor menyusul. Rentang pengerjaan penuh mengikuti paket Web App Custom pada halaman jasa pembuatan website, yaitu 4 sampai 12 minggu tergantung lingkup.' },
        ],
      },
      cta: {
        title: 'Ceritakan bentuk laporan yang kamu kirim sekarang',
        subtitle: 'Kirimkan satu contoh laporan periode terakhir. Dari situ kami bisa menyebutkan lingkup dan angka, bukan menebak.',
        button: 'Kirim Brief',
      },
      schema: {
        serviceName: 'Pembuatan Sistem Dokumentasi dan Pelaporan K3',
      },
    },
    sistemInformasiKlinik: {
      title: 'Sistem Informasi Klinik dan Integrasi Rekam Medis',
      description: 'Sistemnya sudah ada tapi data kunjungan belum terkirim, atau rekam medis masih di kertas. Kami kerjakan integrasi, migrasi data, dan modul yang belum tersedia di sistemmu.',
      kicker: 'Sistem Fasilitas Kesehatan',
      hero: {
        title: 'Sistemnya sudah ada, <span class="ca-gradient-text">yang belum sambungannya</span>',
        subtitle: 'Kami mulai dari yang sudah kamu punya, lalu mengerjakan bagian yang memang belum jalan. Mengganti seluruh sistem hanya kami sarankan kalau memang tidak ada jalan lain, dan alasannya kami sampaikan.',
        ctaPrimary: 'Konsultasi Gratis',
        ctaSecondary: 'Lihat Portofolio',
        ctaTertiary: 'Baca Dasar Aturannya',
      },
      problems: {
        title: 'Yang biasanya terjadi di fasilitas yang sudah punya sistem',
        subtitle: 'Halaman ini ditulis untuk yang sudah membeli sistem, bukan untuk yang belum punya apa-apa.',
        items: [
          { icon: 'lucide:plug-zap', title: 'Data kunjungan tidak sampai ke tujuan', description: 'Pengiriman terlihat berhasil di layar, tapi datanya tidak muncul di sisi penerima. Tidak ada yang bisa menunjukkan pesan galat aslinya.' },
          { icon: 'lucide:files', title: 'Rekam medis masih di kertas', description: 'Berkas menumpuk, pencarian riwayat pasien lama memakan waktu, dan salinan yang hilang tidak bisa dipulihkan.' },
          { icon: 'lucide:keyboard', title: 'Petugas memasukkan data yang sama dua kali', description: 'Satu kali di sistem sendiri, satu kali lagi di portal penjamin. Selisihnya baru ketahuan saat penagihan ditolak.' },
          { icon: 'lucide:puzzle', title: 'Modul yang dibutuhkan tidak ada', description: 'Alur kerjamu punya langkah yang tidak dipikirkan pembuat sistem siap pakai, dan permintaan penambahan tidak pernah masuk antrean.' },
          { icon: 'lucide:database-backup', title: 'Ganti sistem berarti kehilangan riwayat', description: 'Penyedia lama tidak menyediakan ekspor yang utuh, sehingga berpindah terasa seperti memulai dari nol.' },
          { icon: 'lucide:clock', title: 'Antrean menumpuk di jam sibuk', description: 'Pendaftaran, pemanggilan, dan pencatatan dikerjakan di tempat yang berbeda, jadi antreannya lebih panjang daripada penyebab medisnya.' },
        ],
      },
      outcomes: {
        title: 'Yang berubah setelah dibereskan',
        subtitle: 'Tanpa mengganti seluruh sistem, kecuali memang tidak ada jalan lain dan itu kami sampaikan terus terang.',
        items: [
          { icon: 'lucide:link', title: 'Pengiriman data bisa ditelusuri', description: 'Setiap pengiriman punya catatan, termasuk yang gagal beserta alasannya. Yang gagal bisa dikirim ulang tanpa mengetik ulang.' },
          { icon: 'lucide:scan-line', title: 'Riwayat dari sistem lama ikut pindah', description: 'Data dari sistem sebelumnya dipindahkan dan dicocokkan sebelum dan sesudah pindah. Untuk arsip yang masih kertas, pemindaiannya dikerjakan pihak lain dan kami mengerjakan pengindeksan serta pemasukan hasilnya.' },
          { icon: 'lucide:repeat-2', title: 'Satu kali input untuk beberapa tujuan', description: 'Data yang sama tidak diketik ulang untuk kebutuhan penjaminan maupun pelaporan.' },
          { icon: 'lucide:blocks', title: 'Modul yang kurang bisa ditambahkan', description: 'Bagian yang belum tersedia dibangun menempel pada sistem yang sudah kamu pakai, bukan menggantikannya.' },
          { icon: 'lucide:file-check-2', title: 'Dokumen pendukung siap saat diperiksa', description: 'Catatan dan pelaporan tersimpan lengkap dengan penanda waktu, jadi tidak perlu dikumpulkan mendadak.' },
          { icon: 'lucide:shield', title: 'Akses dibatasi sesuai peran', description: 'Data pasien hanya terbuka bagi yang berhak, dan setiap pembukaannya tercatat.' },
        ],
      },
      scope: {
        title: 'Ruang lingkup pekerjaan',
        subtitle: 'Kami tidak mulai dari membangun. Kami mulai dari membaca apa yang sudah berjalan.',
        items: [
          { icon: 'lucide:git-compare', title: 'Pemeriksaan sistem yang sedang berjalan', description: 'Apa yang sudah ada, apa yang layak dipertahankan, dan bagian mana yang benar-benar bermasalah.' },
          { icon: 'lucide:plug', title: 'Pengerjaan integrasi', description: 'Penyambungan ke sistem tujuan, termasuk penanganan kegagalan kirim, pengiriman ulang, dan pencatatan jejaknya.' },
          { icon: 'lucide:database', title: 'Migrasi data', description: 'Pemindahan data dari sistem lama, dengan pemeriksaan kecocokan sebelum dan sesudah pindah. Pemindaian arsip kertas bukan pekerjaan kami, tetapi hasil pemindaiannya bisa kami indeks dan masukkan.' },
          { icon: 'lucide:layout-panel-left', title: 'Modul tambahan', description: 'Bagian yang belum tersedia di sistem sekarang, dibangun mengikuti alur kerja yang sudah berjalan.' },
          { icon: 'lucide:users', title: 'Antrean dan pendaftaran', description: 'Pendaftaran, nomor antrean, dan pemanggilan yang menyatu dengan pencatatan kunjungan.' },
          { icon: 'lucide:file-lock', title: 'Hak akses dan jejak audit', description: 'Pembedaan peran serta pencatatan siapa membuka data apa dan kapan.' },
        ],
      },
      regulation: {
        title: 'Dasar aturan yang kami pakai',
        subtitle: 'Semua kutipan di bawah bisa kamu periksa sendiri pada dokumen resminya.',
        items: [
          {
            title: 'Kewajiban pencatatan dan pelaporan rumah sakit',
            body: 'Pasal 74 ayat (1) Peraturan Menteri Kesehatan Nomor 6 Tahun 2026 tentang Rumah Sakit menyatakan setiap rumah sakit wajib melakukan pencatatan dan pelaporan terhadap semua kegiatan penyelenggaraan rumah sakit dalam Sistem Informasi Kesehatan yang terintegrasi dengan Sistem Informasi Kesehatan Nasional.',
            sourceLabel: 'Permenkes 6 Tahun 2026 di JDIH Kemkes',
            sourceUrl: 'https://jdih.kemkes.go.id/storage/documents/pdfs/2026permenkes006.pdf',
          },
          {
            title: 'Masa penyesuaian',
            body: 'Pasal 83 huruf a memberi waktu paling lama 2 tahun sejak peraturan diundangkan bagi penyelenggaraan rumah sakit untuk menyesuaikan diri dengan ketentuan peraturan ini, jatuh tempo 12 Juni 2028. Huruf b memberi waktu paling lama 4 tahun bagi rumah sakit kelas D pratama yang sudah memiliki perizinan berusaha, jatuh tempo 12 Juni 2030. Perlu dicatat, huruf a mencakup seluruh isi peraturan, bukan khusus sistem informasi.',
            sourceLabel: 'Permenkes 6 Tahun 2026 di JDIH Kemkes',
            sourceUrl: 'https://jdih.kemkes.go.id/storage/documents/pdfs/2026permenkes006.pdf',
          },
          {
            title: 'Sanksi yang berjenjang',
            body: 'Pasal 79 ayat (1) menyebut pelanggaran atas Pasal 74 ayat (1) dikenai teguran lisan, teguran tertulis, denda administratif, penyesuaian atau pencabutan status akreditasi, dan pencabutan perizinan berusaha rumah sakit. Urutannya bertahap. Teguran lisan diberikan paling banyak satu kali dan teguran tertulis paling banyak dua kali sebelum tahap berikutnya.',
            sourceLabel: 'Permenkes 6 Tahun 2026 di JDIH Kemkes',
            sourceUrl: 'https://jdih.kemkes.go.id/storage/documents/pdfs/2026permenkes006.pdf',
          },
          {
            title: 'Klinik bukan subjek peraturan ini',
            body: 'Permenkes 6 Tahun 2026 mengatur rumah sakit. Frasa yang tertulis pada Pasal 83 huruf b adalah rumah sakit kelas D pratama, bukan klinik pratama. Kalau fasilitasmu berbentuk klinik, dasar kewajibannya berbeda dan kami tidak akan mengutip peraturan ini seolah berlaku untukmu. Rujukannya kami cari bersama sebelum lingkup dikunci.',
            sourceLabel: 'Permenkes 6 Tahun 2026 di JDIH Kemkes',
            sourceUrl: 'https://jdih.kemkes.go.id/storage/documents/pdfs/2026permenkes006.pdf',
          },
        ],
        disclaimer: 'Kami menyebut Sistem Informasi Kesehatan Nasional, bukan nama platform tertentu, karena itulah yang tertulis di peraturannya. Kami juga tidak mengklaim status sebagai penyedia rekam medis elektronik yang terdaftar di Kementerian Kesehatan. Kalau pengadaan di tempatmu mensyaratkan penyedia terdaftar, sampaikan sejak awal supaya kamu tidak menghabiskan waktu pada pilihan yang tidak memenuhi syarat.',
      },
      pricing: {
        title: 'Rentang biaya dan durasi',
        subtitle: 'Pekerjaan integrasi paling sulit ditaksir dari luar. Yang bisa kami sebutkan sekarang adalah titik masuk dan hal yang menggerakkan posisimu di dalam rentang.',
        headline: 'Integrasi, migrasi, atau modul tambahan',
        range: 'Mulai Rp 25 juta',
        lowPrice: '25000000',
        duration: 'Pengerjaan 4 sampai 12 minggu',
        note: 'Titik masuk dan durasi di atas mengikuti paket Web App Custom yang sudah kami cantumkan pada halaman jasa pembuatan website. Batas atasnya ditentukan lingkup akhir dan ditulis pada penawaran sebelum pengerjaan dimulai.',
        ...
        factorsTitle: 'Yang menentukan posisimu di dalam rentang',
        factors: [
          { icon: 'lucide:file-search', title: 'Ketersediaan dokumentasi sistem lama', description: 'Sistem yang punya dokumentasi antarmuka jauh lebih cepat disambungkan daripada yang harus dibaca dari perilakunya.' },
          { icon: 'lucide:database', title: 'Volume dan kondisi data', description: 'Jumlah rekam medis dan kerapiannya menentukan berapa lama pemindahan dan pemeriksaan ulangnya.' },
          { icon: 'lucide:handshake', title: 'Kesediaan penyedia lama membuka akses', description: 'Kalau ekspor data harus diminta ke pihak lain, waktunya ditentukan pihak itu, bukan oleh kami.' },
          { icon: 'lucide:layers', title: 'Jumlah modul yang ditambahkan', description: 'Satu modul yang berdiri sendiri berbeda dengan beberapa modul yang saling bergantung.' },
          { icon: 'lucide:building-2', title: 'Jumlah unit layanan', description: 'Satu klinik satu lokasi berbeda dari rumah sakit dengan banyak unit dan alur yang berbeda per unit.' },
          { icon: 'lucide:file-text', title: 'Kebutuhan pelaporan', description: 'Beberapa bentuk laporan yang harus dijaga bersamaan menambah pekerjaan pengujian.' },
        ],
      },
      caseStudy: {
        kicker: 'Sebelum kamu membaca lebih jauh',
        title: 'Kami belum pernah mengerjakan sistem fasilitas kesehatan',
        sector: 'Disampaikan apa adanya',
        description: 'Register portofolio kami tidak memuat satu pun proyek klinik atau rumah sakit. Menampilkan studi kasus yang tidak pernah terjadi lebih merugikan kamu daripada kami, jadi bagian ini kami isi dengan pekerjaan sebenarnya yang paling dekat dengan kebutuhan di halaman ini.',
        points: [
          'Pemisahan data antar penyewa di tingkat skema basis data pada produk kami sendiri',
          'Portal dokumen yang bisa dibuka tanpa akun, dengan salinan yang dibekukan saat diterbitkan',
          'Jejak tiap pengiriman ke layanan pihak ketiga, termasuk yang gagal beserta kode balasannya',
        ],
        note: 'Kalau lembagamu mensyaratkan pengalaman sektor kesehatan sebagai unsur penilaian, kami bukan pilihan yang tepat, dan sebaiknya kamu tahu itu sekarang.',
        ctaLabel: 'Lihat portofolio lengkap',
      },
      related: {
        title: 'Halaman lain yang mungkin kamu butuhkan',
        subtitle: 'Kalau kebutuhanmu ternyata di luar fasilitas kesehatan, tiga halaman ini lebih dekat.',
        items: [
          { icon: 'lucide:hard-hat', title: 'Sistem pelaporan P2K3 dan dokumentasi K3', description: 'Untuk kewajiban pelaporan keselamatan kerja dan lembaga pelatihan K3.', to: '/layanan/sistem-pelaporan-k3' },
          { icon: 'lucide:receipt', title: 'Sistem manajemen transaksi dan operasional', description: 'Untuk pesanan, penagihan, dan stok yang catatannya tidak pernah cocok.', to: '/layanan/sistem-manajemen-transaksi' },
          { icon: 'lucide:layout-dashboard', title: 'Jasa pembuatan aplikasi web', description: 'Halaman umum untuk sistem internal yang tidak masuk tiga kategori di atas.', to: '/layanan/jasa-pembuatan-aplikasi-web' },
        ],
      },
      faq: {
        title: 'Pertanyaan yang sering muncul',
        items: [
          { question: 'Fasilitas kami sudah terdaftar tapi datanya tidak masuk, apa penyebabnya?', answer: 'Tiga hal yang kami periksa lebih dulu: bentuk kiriman tidak sesuai yang diminta penerima, penanda identitas pasien belum lengkap, dan kegagalan kirim yang tidak pernah ditampilkan ke petugas sehingga tidak ada yang tahu harus mengulang. Ketiganya baru bisa dipastikan setelah jejak pengirimannya dibaca.' },
          { question: 'Apakah sistem yang sekarang harus dibuang?', answer: 'Tidak selalu, dan itu bukan keputusan yang kami ambil sebelum melihat sistemnya. Kalau pencatatan hariannya sudah dipakai dan tidak bermasalah, mengganti seluruhnya justru menambah risiko. Yang biasanya perlu dikerjakan hanya bagian yang tidak jalan.' },
          { question: 'Apakah CoreAsia mengerjakan pemindaian rekam medis kertas?', answer: 'Tidak. Pemindaian arsip bukan pekerjaan kami dan kami tidak menjualnya. Yang kami kerjakan adalah pengindeksan dan pemasukan hasil pemindaian ke sistem, serta aturan mana yang berlaku selama arsip kertas dan sistem baru dipakai berdampingan. Urutan pemindahannya kamu yang tentukan bersama tim medismu.' },
          { question: 'Berapa lama pengerjaan integrasi?', answer: 'Bergantung pada ketersediaan dokumentasi antarmuka dan kecepatan pihak penerima merespons. Bagian yang kami kendalikan biasanya bukan bagian yang paling lama. Kami sebutkan taksiran waktunya setelah membaca jejak pengiriman yang ada sekarang.' },
          { question: 'Apakah CoreAsia penyedia rekam medis elektronik terdaftar?', answer: 'Kami tidak mengklaim status itu. Kalau pengadaan di tempatmu mensyaratkan penyedia terdaftar, sampaikan sejak awal supaya lingkup dan kelayakannya jelas sebelum kamu mengeluarkan waktu.' },
          { question: 'Apakah peraturan rumah sakit yang baru berlaku untuk klinik?', answer: 'Tidak. Permenkes 6 Tahun 2026 mengatur rumah sakit. Pasal 83 huruf b menyebut rumah sakit kelas D pratama, bukan klinik pratama. Untuk klinik, dasar kewajibannya harus dicari terpisah, dan kami tidak akan memakai peraturan ini sebagai alasan.' },
          { question: 'Bagaimana data pasien dijaga?', answer: 'Akses dibatasi per peran, setiap pembukaan data tercatat, dan data dipindahkan lewat jalur terenkripsi. Ketentuan tambahan yang berlaku di fasilitasmu kami ikuti dan tulis pada perjanjian sebelum pengerjaan dimulai.' },
        ],
      },
      cta: {
        title: 'Kirim satu contoh kegagalan kirim yang kamu alami',
        subtitle: 'Tangkapan layar galat atau catatan pengirimannya sudah cukup untuk kami menyebutkan kemungkinan penyebab dan lingkup pekerjaannya.',
        button: 'Kirim Brief',
      },
      schema: {
        serviceName: 'Pembuatan dan Integrasi Sistem Informasi Fasilitas Kesehatan',
      },
    },
    sistemManajemenTransaksi: {
      title: 'Sistem Manajemen Transaksi dan Operasional',
      description: 'Pesanan masuk lewat obrolan, rekap di lembar sebar, angkanya berbeda dengan gudang. Kami bangun sistem transaksi yang mengikuti alur kerja timmu, bukan sebaliknya.',
      kicker: 'Sistem Transaksi',
      hero: {
        title: 'Pesanan lewat obrolan jadi <span class="ca-gradient-text">catatan yang bisa dipercaya</span>',
        subtitle: 'Timmu tidak perlu berhenti memakai aplikasi pesan. Yang perlu berubah adalah apa yang terjadi setelah pesanan itu masuk.',
        ctaPrimary: 'Konsultasi Gratis',
        ctaSecondary: 'Lihat Portofolio',
        ctaTertiary: 'Lihat Rentang Biaya',
      },
      problems: {
        title: 'Yang biasanya terjadi di akhir bulan',
        subtitle: 'Halaman ini ditulis untuk yang sudah pernah mencoba aplikasi siap pakai lalu berhenti memakainya.',
        items: [
          { icon: 'lucide:message-circle-off', title: 'Pesanan terselip di antara pesan lain', description: 'Pesanan masuk berbarengan dengan pertanyaan dan obrolan biasa. Satu yang terlewat baru ketahuan saat pembelinya menagih.' },
          { icon: 'lucide:file-spreadsheet', title: 'Rekap harian diketik ulang dari obrolan', description: 'Satu orang menghabiskan sebagian harinya menyalin isi obrolan ke lembar sebar. Salah ketik ikut masuk tanpa ada yang memeriksa.' },
          { icon: 'lucide:scale', title: 'Angka penjualan tidak cocok dengan stok', description: 'Penjualan dicatat di satu tempat, barang keluar dicatat di tempat lain. Selisihnya baru terlihat saat penghitungan fisik.' },
          { icon: 'lucide:receipt-text', title: 'Bukti pembayaran hilang di obrolan', description: 'Bukti transfer dikirim lalu tertimbun. Saat ditagih, tidak ada yang bisa menunjukkan sudah dibayar atau belum.' },
          { icon: 'lucide:copy', title: 'Tim bekerja dua kali', description: 'Sudah ada aplikasi, tapi tim tetap memegang lembar sebar sendiri karena aplikasinya tidak mengikuti cara mereka bekerja.' },
          { icon: 'lucide:file-clock', title: 'Penagihan bertahap tidak ada yang menjaga', description: 'Termin kedua dan ketiga terlewat karena tidak ada yang mengingatkan selain ingatan orang.' },
        ],
      },
      outcomes: {
        title: 'Yang berubah setelah dibereskan',
        subtitle: 'Tanpa memaksa pelanggan berpindah saluran dan tanpa mengganti semua sistem sekaligus.',
        items: [
          { icon: 'lucide:inbox', title: 'Pesanan punya satu tempat masuk', description: 'Dari mana pun pesanannya datang, catatannya berakhir di satu tempat dengan nomor, status, dan pemilik yang jelas.' },
          { icon: 'lucide:refresh-cw', title: 'Penjualan dan stok bergerak dari satu peristiwa', description: 'Barang keluar tercatat karena pesanannya berubah status, bukan karena ada yang mengingat untuk mencatatnya.' },
          { icon: 'lucide:bell', title: 'Termin dan tenggat mengingatkan sendiri', description: 'Penagihan yang belum jatuh tempo, yang sudah lewat, dan yang sudah dibayar terlihat tanpa perlu dicari.' },
          { icon: 'lucide:workflow', title: 'Persetujuan internal punya jejak', description: 'Siapa menyetujui apa dan kapan tercatat, jadi tidak ada lagi pertanyaan siapa yang memutuskan.' },
          { icon: 'lucide:eye', title: 'Angka yang sama untuk semua orang', description: 'Tidak ada lagi dua versi rekap yang berbeda antara bagian penjualan dan bagian gudang.' },
          { icon: 'lucide:message-square', title: 'Aplikasi pesan tetap boleh dipakai', description: 'Pintu masuknya tidak dipaksa berubah. Yang berubah hanya tempat catatannya berakhir.' },
        ],
      },
      scope: {
        title: 'Ruang lingkup pekerjaan',
        subtitle: 'Tahap pertama sengaja dibuat kecil. Yang penting satu jenis kesalahan berhenti terjadi.',
        items: [
          { icon: 'lucide:clipboard-list', title: 'Pencatatan pesanan', description: 'Nomor pesanan, pelanggan, isi pesanan, status, dan riwayat perubahannya.' },
          { icon: 'lucide:package', title: 'Stok dan barang keluar', description: 'Pergerakan stok yang terikat pada peristiwa pesanan, termasuk penyesuaian manual yang tetap tercatat.' },
          { icon: 'lucide:receipt', title: 'Penagihan dan pembayaran', description: 'Faktur, termin, penandaan lunas, dan penyimpanan bukti bayar pada pesanannya.' },
          { icon: 'lucide:check-check', title: 'Alur persetujuan', description: 'Langkah persetujuan internal yang mengikuti aturan yang sudah berlaku di tempatmu.' },
          { icon: 'lucide:bar-chart-3', title: 'Rekap dan laporan', description: 'Rekap harian dan bulanan, serta ekspor untuk kebutuhan pembukuan.' },
          { icon: 'lucide:key-round', title: 'Peran dan hak akses', description: 'Pembedaan akses antara penjualan, gudang, keuangan, dan pemilik.' },
        ],
      },
      pricing: {
        title: 'Rentang biaya dan durasi',
        subtitle: 'Angka pastinya keluar setelah lingkup dikunci. Yang bisa kami sebutkan sekarang adalah titik masuk dan hal yang menggerakkan posisimu di dalam rentang.',
        headline: 'Sistem transaksi dan operasional',
        range: 'Mulai Rp 25 juta',
        lowPrice: '25000000',
        duration: 'Pengerjaan 4 sampai 12 minggu',
        note: 'Titik masuk dan durasi di atas mengikuti paket Web App Custom yang sudah kami cantumkan pada halaman jasa pembuatan website. Batas atasnya ditentukan lingkup akhir dan ditulis pada penawaran sebelum pengerjaan dimulai.',
        ...
        factorsTitle: 'Yang menentukan posisimu di dalam rentang',
        factors: [
          { icon: 'lucide:git-branch', title: 'Jumlah jalur pesanan', description: 'Satu jalur pesanan berbeda dengan pesanan yang datang dari beberapa saluran sekaligus.' },
          { icon: 'lucide:package', title: 'Ada tidaknya stok fisik', description: 'Usaha jasa tidak memerlukan pergerakan stok, dan itu memangkas sebagian besar pekerjaan.' },
          { icon: 'lucide:credit-card', title: 'Cara pembayaran diterima', description: 'Penandaan lunas secara manual lebih sederhana daripada sambungan ke penyedia pembayaran berizin Bank Indonesia.' },
          { icon: 'lucide:users-round', title: 'Jumlah peran dan langkah persetujuan', description: 'Semakin banyak langkah yang harus dilewati sebuah pesanan, semakin banyak yang harus diuji.' },
          { icon: 'lucide:file-input', title: 'Kondisi data yang dipindahkan', description: 'Lembar sebar yang seragam lebih cepat dipindahkan daripada berkas yang bentuknya berubah tiap bulan.' },
          { icon: 'lucide:plug', title: 'Sambungan ke sistem lain', description: 'Menyambung ke sistem pembukuan atau pengiriman yang sudah kamu pakai menambah pekerjaan.' },
        ],
      },
      caseStudy: {
        kicker: 'Studi Kasus',
        title: 'Sistem penjualan multi ruang kerja',
        sector: 'Sektor penjualan dan operasional bisnis',
        description: 'Kami membangun sistem penjualan yang menangani jalur kesepakatan, penawaran, faktur, portal dokumen yang bisa dibuka pelanggan tanpa akun, cakupan data per peran, dan pembayaran. Ini produk kami sendiri, bukan pesanan klien, dan sistemnya berjalan di produksi. Satu pemasangan menampung banyak ruang kerja dengan pemisahan data di tingkat skema basis data.',
        points: [
          'Jalur kesepakatan dengan tahapan yang bisa diatur sendiri',
          'Penawaran dan faktur yang dirender di server menjadi PDF',
          'Portal dokumen tanpa akun untuk persetujuan dan unggah bukti bayar',
          'Pembayaran lewat penyedia berizin Bank Indonesia',
        ],
        note: 'Yang relevan di sini: bagian tersulit bukan membuat formulir pesanan, melainkan menjaga satu angka tetap sama di seluruh sistem saat banyak orang mengubahnya bersamaan.',
        ctaLabel: 'Lihat portofolio lengkap',
      },
      related: {
        title: 'Halaman lain yang mungkin kamu butuhkan',
        subtitle: 'Kalau masalahmu ternyata bukan transaksi, tiga halaman ini lebih dekat.',
        items: [
          { icon: 'lucide:hard-hat', title: 'Sistem pelaporan P2K3 dan dokumentasi K3', description: 'Untuk kewajiban pelaporan keselamatan kerja dan lembaga pelatihan K3.', to: '/layanan/sistem-pelaporan-k3' },
          { icon: 'lucide:stethoscope', title: 'Sistem informasi klinik dan rekam medis', description: 'Untuk fasilitas kesehatan yang sistemnya sudah ada tapi belum tersambung.', to: '/layanan/sistem-informasi-klinik' },
          { icon: 'lucide:globe', title: 'Jasa pembuatan website', description: 'Kalau yang kamu butuhkan halaman publik lebih dulu, bukan sistem internal.', to: '/layanan/jasa-pembuatan-website' },
        ],
      },
      faq: {
        title: 'Pertanyaan yang sering muncul',
        items: [
          { question: 'Kami sudah coba aplikasi siap pakai tapi tidak cocok, salahnya di mana?', answer: 'Biasanya bukan pada aplikasinya. Aplikasi siap pakai dibangun dari alur kerja rata-rata, sementara yang membuat usahamu berjalan sering justru langkah yang tidak rata-rata. Saat dua hal itu bertabrakan, tim memilih cara yang lebih cepat dan sistemnya ditinggalkan.' },
          { question: 'Apakah harus ganti semua sistem sekaligus?', answer: 'Tidak, dan kami tidak menyarankannya. Yang paling sering berhasil adalah mengambil satu bagian yang paling sering menimbulkan kesalahan, membereskannya, lalu melihat apakah bagian berikutnya masih perlu dikerjakan.' },
          { question: 'Bagaimana kalau tim tetap mau menerima pesanan lewat aplikasi pesan?', answer: 'Silakan. Memaksa pelanggan berpindah saluran adalah cara tercepat kehilangan pesanan. Yang kami rapikan adalah apa yang terjadi setelah pesanan diterima, bukan cara pelanggan menghubungimu.' },
          { question: 'Berapa banyak yang perlu dibangun di tahap pertama?', answer: 'Secukupnya untuk menghentikan satu jenis kesalahan yang paling sering terjadi. Kalau tahap pertama sudah menyentuh lima bagian sekaligus, biasanya lingkupnya perlu dipotong lagi.' },
          { question: 'Apakah data dari lembar sebar bisa dipindahkan?', answer: 'Bisa, sepanjang kolomnya konsisten. Berkas yang bentuknya berubah tiap bulan perlu dirapikan lebih dulu, dan itu pekerjaan tersendiri yang kami sebutkan terpisah pada penawaran.' },
          { question: 'Apakah sistemnya bisa menerima pembayaran?', answer: 'Bisa, lewat penyedia pembayaran berizin Bank Indonesia. Pendaftaran dan perjanjian dengan penyedia itu atas nama usahamu sendiri, bukan atas nama kami.' },
          { question: 'Siapa pemilik kode programnya?', answer: 'Kode program menjadi milikmu sepenuhnya setelah proyek selesai dan pembayaran lunas.' },
        ],
      },
      cta: {
        title: 'Ceritakan satu pesanan yang terlewat bulan ini',
        subtitle: 'Satu contoh nyata lebih berguna daripada daftar kebutuhan. Dari situ kami bisa menunjuk bagian mana yang perlu dibereskan lebih dulu.',
        button: 'Kirim Brief',
      },
      schema: {
        serviceName: 'Pembuatan Sistem Manajemen Transaksi dan Operasional',
      },
    },
  },
  // Articles
  ...
  portfolio: {
    ...
    description: 'Portfolio proyek CoreAsia: sistem pelatihan dan sertifikasi untuk klien, CRM untuk tim penjualan, dashboard pemantauan website, aplikasi desktop, dan situs perusahaan.',
    kicker: 'Portfolio',
    heading: 'Proyek yang Sudah Kami Bangun',
    subtitle: 'Dari konsep sampai produksi. Tiga proyek pertama punya studi kasus tertulis dengan sumber angka yang bisa diperiksa satu per satu; sisanya produk yang kami bangun dan pakai sendiri.',
    items: [
      {
        title: 'Sistem Pelatihan dan Sertifikasi K3',
        category: 'Klien Pihak Ketiga',
        description: 'Situs publik dan konsol pengelola untuk sebuah lembaga pelatihan dan sertifikasi keselamatan dan kesehatan kerja. Calon peserta membaca katalog pelatihan dan jadwal kelas lalu mendaftar langsung dari situs, sementara pengelola mengurus pendaftaran, penjualan sampai faktur, artikel, dan galeri dari satu konsol dengan hak akses yang diatur per pengguna. Yang kami sebut di sini sektornya, bukan nama lembaganya.',
        highlights: ['Peta situs tumbuh dari 11 halaman saat pemantauan hasil pencarian dipasang menjadi 150 halaman', 'Katalog dan artikel diubah sendiri oleh pengelola lewat konsol, tanpa menunggu perubahan kode', 'Penyalinan halaman oleh domain lain ditangani dengan tiga lapis penangkal dan laporan hak cipta', 'Sambungan ke situs dipaksa terenkripsi dan isi halaman dibatasi hanya dari sumber yang diizinkan'],
        meta: ['Aktivitas pengembangan Desember 2025 sampai Juni 2026', 'Dikerjakan satu pengembang', 'Bukti diperiksa ulang 7 September 2026'],
      },
      {
        title: 'LeadKu by CoreAsia',
        category: 'Produk SaaS',
        description: 'CRM untuk tim penjualan yang menampung banyak ruang kerja sekaligus. Satu tempat untuk mengurus tahapan penjualan, menerbitkan penawaran dan faktur, membagikan dokumen ke klien lewat tautan tanpa akun, membatasi data yang terlihat per peran, dan bertanya ke asisten penjualan bernama Leo soal isi pipeline. Data tiap perusahaan pelanggan berdiri sendiri dan tidak bercampur satu sama lain.',
        link: 'https://leadku.coreasia.id',
        highlights: ['Data tiap perusahaan pelanggan berdiri di ruangnya sendiri', 'Jawaban asisten penjualan muncul bertahap, tidak menunggu selesai semua', 'Penawaran dan faktur keluar sebagai PDF yang siap dikirim', 'Langganan dibayar lewat penyedia pembayaran berizin Bank Indonesia'],
        meta: ['Aktivitas pengembangan Maret sampai Agustus 2026', 'Dikerjakan satu pengembang', 'Bukti diperiksa ulang 7 September 2026'],
      },
      {
        title: 'Pantau by CoreAsia',
        category: 'Produk SaaS',
        description: 'Dashboard pemantauan website yang menyatukan data pengunjung, hasil pencarian, peringkat kata kunci, pemeriksaan SEO, asisten tanya jawab, dan laporan PDF terjadwal dalam satu layar. Dipakai untuk memeriksa performa sebuah situs tanpa berpindah-pindah alat.',
        link: 'https://pantau.coreasia.id',
        highlights: ['Data pengunjung, hasil pencarian, dan kecepatan halaman ditarik sendiri dari sumber resmi', 'Skor kecepatan halaman disimpan sebagai riwayat, bukan hanya angka saat ini', 'Laporan PDF berkala terbit sendiri mengikuti jadwal yang ditetapkan', 'Antarmuka dua bahasa penuh, 2.105 kunci teks per bahasa'],
        meta: ['Aktivitas pengembangan Maret sampai Agustus 2026', 'Dikerjakan satu pengembang', 'Bukti diperiksa ulang 7 September 2026'],
      },
      {
        title: 'CoreAsia Downloader',
        category: 'Aplikasi Desktop',
        description: 'Aplikasi desktop untuk menyimpan video dan audio dari situs berbagi video. Tempel tautannya, atau biarkan pendamping peramban menemukan media di halaman yang sedang kamu buka. Pilih resolusinya atau ambil audionya saja, lalu unduhan berjalan di antrean yang boleh ditinggal.',
        link: 'https://coreasia.id/products/downloader',
        highlights: ['Antrean unduhan berjalan bersamaan dan tidak hilang saat aplikasi ditutup', 'Resolusi dan berkas terjemahan dipilih sebelum unduhan dimulai', 'Pendamping peramban mengirim media yang terdeteksi langsung ke aplikasi', 'Lisensi diperiksa di sisi server, bukan hanya di komputer pemakai'],
        meta: ['Dipakai perorangan, dipasang sendiri di komputer', 'Tersedia untuk macOS, versi Windows berstatus beta', 'Bisa dicoba gratis tiga hari sebelum membeli'],
      },
      {
        title: 'CoreAsia Mounter',
        category: 'Aplikasi Desktop',
        description: 'Utilitas kecil di bilah menu macOS yang membuat drive berformat NTFS bisa ditulis di Mac Apple Silicon. Drive dikenali dan siap dipakai begitu dicolok, tanpa memasang komponen tambahan ke dalam sistem operasi dan tanpa menurunkan pengaturan keamanan Mac.',
        link: 'https://coreasia.id/products/mounter',
        highlights: ['Pengaturan keamanan Mac tidak perlu diturunkan', 'Drive dikenali dan terpasang sendiri begitu dicolok', 'Bagian yang butuh hak akses tinggi dipisahkan dari aplikasinya', 'Membaca isi drive gratis, menulis dibuka dengan lisensi'],
        meta: ['Dipakai perorangan di Mac Apple Silicon', 'Membaca gratis selamanya, menulis sekali bayar tanpa langganan', 'Fitur tulis bisa dicoba gratis satu hari'],
      },
      {
        title: 'CoreAsia Beres',
        category: 'Produk SaaS',
        description: 'Empat alat berbasis peramban untuk merapikan berkas dan daftar nomor. Kompres foto dan kompres PDF bisa dipakai gratis tanpa akun. BerkasKilat menyesuaikan seluruh berkas pendaftaran CPNS, SNBT, dan SPMB dengan preset ukuran resmi instansi, sedangkan RapiKontak menyeragamkan daftar nomor telepon ke format 62 lalu membuang duplikat dan nomor yang tidak valid.',
        link: 'https://tools.coreasia.id',
        highlights: ['Dua alat gratis tanpa batas pemakaian', 'Sekali bayar lewat pindai kode, tanpa akun dan tanpa langganan', 'Berkas dihapus otomatis setelah proses selesai'],
        meta: ['Dipakai pendaftar seleksi masuk, penjual, dan admin grup', 'Berjalan di peramban, tidak perlu dipasang', 'Dua alat gratis dan dua alat sekali bayar'],
      },
      {
        title: 'CoreAsia Landing & CMS',
        category: 'Situs Perusahaan',
        description: 'Situs perusahaan CoreAsia sendiri, termasuk halaman produk, halaman layanan, dan artikel. Isi halaman ditulis dan diterbitkan dari konsol pengelola dalam dua bahasa, jadi teks yang kamu baca sekarang bisa diganti tanpa menunggu perubahan kode.',
        highlights: ['Seluruh isi tersedia dalam Bahasa Indonesia dan Inggris', 'Artikel ditulis dan diterbitkan lewat penyunting di konsol pengelola', 'Setiap halaman membawa data terstruktur supaya terbaca mesin pencari', 'Halaman terbuka cepat karena sebagian sudah disiapkan sebelum diminta'],
        meta: ['Situs milik CoreAsia sendiri, bukan pekerjaan pesanan klien', 'Tayang di coreasia.id, halaman ini bagian darinya', 'Terbuka untuk umum, tanpa akun'],
      },
    ],
    viewProject: 'Lihat Proyek',
    cta: {
      title: 'Punya proyek digital?',
      subtitle: 'Ceritakan ide kamu. Kami bantu dari konsep sampai tayang di produksi.',
      button: 'Diskusikan Proyek Kamu',
    },
  },
  // Legal pages
  legal: {
  ...
  components: {
    ...
    footer: {
      ...
      serviceLinks: [
        ...
        { label: 'Sistem Pelaporan K3', to: '/layanan/sistem-pelaporan-k3' },
        { label: 'Sistem Informasi Klinik', to: '/layanan/sistem-informasi-klinik' },
        { label: 'Sistem Manajemen Transaksi', to: '/layanan/sistem-manajemen-transaksi' },
      ],
    },
    trustedBy: {
