...
const KAMUS = {
  id: {
    ...
    tab: { label: 'Tab pengguna', ringkas: 'Ringkas', ruang: 'Ruang', transaksi: 'Transaksi', dompet: 'Dompet', jejak: 'Jejak', akses: 'Akses', lainnya: 'Lainnya (0)' },
    kasus: {
  ...
  en: {
    ...
    tab: { label: 'User tabs', ringkas: 'Summary', ruang: 'Workspaces', transaksi: 'Transactions', dompet: 'Wallets', jejak: 'Trail', akses: 'Access', lainnya: 'Others (0)' },
    kasus: {
