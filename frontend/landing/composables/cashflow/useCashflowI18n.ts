...
const KAMUS = {
  id: {
    ...
    pengguna: {
      judul: 'Pengguna', ket: 'Email tampil lengkap. Setiap kali halaman ini dibuka, satu baris audit ditulis atas nama akun console yang membukanya. Membuka satu orang tetap butuh alasan tersendiri.',
  ...
  en: {
    ...
    pengguna: {
      judul: 'Users', ket: 'Emails are shown in full. Every time this page opens, one audit row is written under the console account that opened it. Opening one person still needs its own reason.',
