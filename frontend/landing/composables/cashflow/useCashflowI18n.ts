...
const KAMUS = {
  id: {
    ...
    pengguna: {
      ...
      tampilkanEmail: 'Tampilkan email lengkap', samarkanEmail: 'Samarkan lagi',
      terbukaKet: 'Email lengkap sedang tampil. Pembukaan ini tercatat di audit atas nama Master.',
  ...
  en: {
    ...
    pengguna: {
      ...
      tampilkanEmail: 'Show full emails', samarkanEmail: 'Mask again',
      terbukaKet: 'Full emails are showing. This reveal is recorded in the audit log under your name.',
