...
useCoreSeo({
    title: t('legal.privacy.title') as string,
    description: t('legal.privacy.description') as string,
    path: '/privacy-policy',
})

const sections = computed(() => {
    const raw = t('legal.privacy.sections') as Record<string, any>
...
<template>
    <div>
        <section class="relative overflow-hidden">
            ...
            <div ref="heroSection" class="ca-container relative ca-section pt-0 sm:pt-0 pb-8">
