...
useCoreSeo({
    title: t('legal.downloaderPrivacy.title') as string,
    description: sub(t('legal.downloaderPrivacy.description') as string) as string,
    path: '/downloader/privacy',
})

const sections = computed(() => {
    const raw = t('legal.downloaderPrivacy.sections') as Record<string, any>
    ...
    <div>
        <section class="relative overflow-hidden">
            ...
            <div ref="heroSection" class="ca-container relative ca-section pt-6 sm:pt-8 pb-8">
                ...
                >
                    {{ t('legal.downloaderPrivacy.title') }}
                </h1>
                <p class="ca-copy mt-4">
                    {{ t('legal.downloaderPrivacy.lastUpdated') }}
                </p>
            </div>
        </section>
