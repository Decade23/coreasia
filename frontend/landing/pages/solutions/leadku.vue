        ...
        <div class="grid gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:items-center">
          <div>
            <span class="ca-kicker">
              <Icon name="lucide:briefcase-business" class="h-3.5 w-3.5 text-amber-300" />
      ...
      <div class="ca-container">
        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          >
            ...
            >
              <Icon :name="feature.icon" class="h-5 w-5 text-amber-300" />
            </div>
        ...
        <div class="grid gap-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          ...
          <div class="grid gap-3">
            ...
            >
              ...
              >
                <Icon :name="item.icon" class="h-4 w-4 text-amber-300" />
              </div>
